...
<div class="card p-6 mb-7" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <a href="<%= request.getContextPath() %>/payroll?action=list" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-green-100 bg-green-50 hover:bg-green-100 transition-all text-center no-underline">
        ...
        <a href="<%= request.getContextPath() %>/leave?action=list" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-amber-100 bg-amber-50 hover:bg-amber-100 transition-all text-center no-underline">
        ...
        <a href="<%= request.getContextPath() %>/attendance?action=list" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-sky-100 bg-sky-50 hover:bg-sky-100 transition-all text-center no-underline">
                ...
                <tr>
                    <td colspan="5" class="py-12 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="<%= request.getContextPath() %>/employee?action=add" class="text-sm text-indigo-600 font-medium hover:underline">Add first employee →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
