...
<div class="flex items-center justify-between mb-6">
    <div></div>
    <a href="<%= request.getContextPath() %>/support/raise" class="btn-primary no-underline">+ New Ticket</a>
</div>
                ...
                <tr>
                    <td colspan="6" class="py-16 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="<%= request.getContextPath() %>/support/raise" class="text-sm text-indigo-600 font-medium hover:underline">Raise your first ticket →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
