...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<%= request.getContextPath() %>/support?action=raise" class="btn-primary no-underline">+ New Ticket</a>
</div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-gray-900 text-sm font-medium" style="max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%= t.getTitle() != null ? t.getTitle() : "—" %></td>
                ...
                <tr class="empty-state">
                    <td colspan="6">
                        <div class="flex flex-col items-center gap-2 py-6">
                            ...
                            <a href="<%= request.getContextPath() %>/support?action=raise" class="text-sm text-indigo-600 font-medium hover:underline">Raise your first ticket →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
