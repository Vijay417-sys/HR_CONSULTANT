...
<div class="flex items-center justify-between mb-6">
    <div class="grid grid-cols-3 gap-4">
        <div class="card px-5 py-3 text-center hover:border-amber-200 transition-all">
            <p class="text-lg font-bold text-amber-500"><%= pending %></p>
            <p class="text-xs text-gray-400 font-medium">Pending</p>
        </div>
        <div class="card px-5 py-3 text-center hover:border-green-200 transition-all">
            <p class="text-lg font-bold text-green-600"><%= approved %></p>
            <p class="text-xs text-gray-400 font-medium">Approved</p>
        </div>
        <div class="card px-5 py-3 text-center hover:border-red-200 transition-all">
            <p class="text-lg font-bold text-red-500"><%= rejected %></p>
            <p class="text-xs text-gray-400 font-medium">Rejected</p>
        </div>
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center font-semibold text-gray-900"><%= days %></td>
